package com.example.application.views.findmyatm;
...
public class FindmyatmView extends Div {
    ...
    private PhoneNumberField phone = new PhoneNumberField("Select Currency");
    ...
    private static class PhoneNumberField extends CustomField<String> {
        ...
        public PhoneNumberField(String label) {
            ...
            countryCode.setPlaceholder("Select Currency");
